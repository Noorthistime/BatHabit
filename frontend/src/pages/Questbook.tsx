        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-6 mt-2">
          ...
          <div className="relative w-full max-w-sm">
            ...
            <input 
              ...
              className="w-full bg-[#1B263B]/30 dark:bg-[#200000]/60 border border-[#415A77]/50 dark:border-[#D4AF37]/35 text-[#F7F3E9] dark:text-[#EEEAD7] text-sm pl-9 pr-3 py-2 rounded focus:outline-none focus:border-[#D4AF37]/70 placeholder-[#F7F3E9]/30 dark:placeholder-[#8d9685]/50 shadow-inner"
            />
            <div className="absolute right-2 top-1.5 p-1 bg-[#415A77]/20 dark:bg-[#3a0404] rounded border border-[#415A77]/30 dark:border-[#D4AF37]/35">
            ...
            <div className="flex items-center gap-2">
              ...
              {DISCIPLINES.map(d => (
                <button 
                  ...
                  className={`px-3 py-1 rounded border font-mono text-[9px] uppercase tracking-widest transition-colors ${selectedDisc === d ? 'bg-[#D4AF37]/10 dark:bg-[#D4AF37]/20 border-[#D4AF37] text-[#D4AF37] dark:text-[#F5D77F] font-bold shadow-[0_0_10px_rgba(212,175,55,0.2)]' : 'bg-transparent border-[#415A77]/30 dark:border-[#D4AF37]/30 text-[#F7F3E9]/50 dark:text-[#8d9685] hover:border-[#D4AF37]/60'}`}
                >
                  {d}
                </button>
              ))}
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              {TIERS.map(t => (
                <button 
                  ...
                  className={`px-3 py-1 rounded border font-mono text-[9px] uppercase tracking-widest transition-colors ${selectedTier === t ? 'bg-[#D4AF37]/10 dark:bg-[#D4AF37]/20 border-[#D4AF37] text-[#D4AF37] dark:text-[#F5D77F] font-bold shadow-[0_0_10px_rgba(212,175,55,0.2)]' : 'bg-transparent border-[#415A77]/30 dark:border-[#D4AF37]/30 text-[#F7F3E9]/50 dark:text-[#8d9685] hover:border-[#D4AF37]/60'}`}
                >
                  {t}
                </button>
              ))}
