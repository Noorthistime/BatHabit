  ...
  return (
    <div className="max-w-4xl mx-auto space-y-16 pb-20">
      ...
      >
        ...
        <motion.div variants={fadeIn} className="bg-[#1B263B]/50 dark:bg-[#1a0101]/50 border border-[#415A77] dark:border-[#3a0404] p-6 rounded-lg shadow-lg">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div variants={slideLeft} className="bg-[#1B263B]/50 dark:bg-[#1a0101]/50 border border-[#415A77] dark:border-[#3a0404] p-6 rounded-lg shadow-lg">
          ...
          <motion.div variants={slideRight} className="bg-[#1B263B]/50 dark:bg-[#1a0101]/50 border border-[#415A77] dark:border-[#3a0404] p-6 rounded-lg shadow-lg md:mt-12">
            <div className="flex items-center gap-4 mb-4">
              <div className="bg-[#0D1B2A] dark:bg-[#060102] p-3 rounded-full border border-[#415A77] dark:border-[#3a0404] text-[#D4AF37]">
                <BookOpen size={24} />
              </div>
      ...
      >
        ...
        <div className="relative pl-12 md:pl-16 space-y-12">
          ...
          <motion.div variants={slideRight} className="relative bg-[#1B263B]/50 dark:bg-[#1a0101]/50 border border-[#415A77] dark:border-[#3a0404] p-6 rounded-lg shadow-lg">
